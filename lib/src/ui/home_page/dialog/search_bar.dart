...
class _AdressBarState extends State<AdressBar> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Consumer(builder: (context, ref, child) {
        final serviceNotifier = ref.watch(servicesProvider);
        return Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        onChanged: (value) {
                          serviceNotifier.searchPlaces(value: value);
                        },
                        onTap: () {
                          homeNotifier.isWhere = true;
                          _onchange();
            ...
            Expanded(
              child: StreamBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    int count = serviceNotifier.resultData.length < 5 ? serviceNotifier.resultData.length : 5;
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: List<Widget>.generate(
                          count,
                            ...
                            onTap: () {
                              ...
                              if (homeNotifier.isWhere == true) {
                                homeNotifier.whereController
                                    .setText(serviceNotifier.resultData[index]);
                              } else {
                                homeNotifier.whereGoController
                                    .setText(serviceNotifier.resultData[index]);
                              }
                              homeNotifier
                                  .getLocationFromaddress(serviceNotifier.resultData[index])
                                  .then((value) {
                                if (value != null) {
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                serviceNotifier.resultData[index],
                                style: theme.textStyle.copyWith(
                                  fontSize: 16.o,
  ...
  //
  //     resultData = List<String>.from(mainModel.data.map((x) => x.toString()));
  //
  //     controller.sink.add(resultData.length);
  //   }
  // }
